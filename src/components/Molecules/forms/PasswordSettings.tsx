...
export function PasswordSettings() {
    return <div className="w-full sm:w-fit flex flex-col">
        ...
        <div className="mt-6">
            <div className="mt-2 border-b border-gray-200 flex justify-start px-4 py-5 gap-2 md:gap-12 lg:gap-20">
                ...
                <Input className="sm:w-96" name="old_password" type="password"></Input>
            </div>
            <div className="mt-2 border-b border-gray-200 flex justify-start px-4 py-5 gap-2 md:gap-12 lg:gap-20">
                <label
                    htmlFor="username"
                ...
                <Input className="sm:w-96" name="new_password" type="password"></Input>
            </div>
            <div className="mt-2 border-b border-gray-200 flex justify-start px-4 py-5 gap-2 md:gap-12 lg:gap-20">
                <label
                    htmlFor="username"
                ...
                <Input className="sm:w-96" name="confirm_password" type="password"></Input>
            </div>
        </div>
    </div>;
}
