import Transaction from "../../components/Molecules/cards/logs/Transaction"
import TransactionTitle from "../../components/Molecules/cards/logs/TransactionTitle"
    ...
    return (
        <AdminLayout>
            <div className="w-full bg-[#F7F8FC]">
                ...
                <div className="w-max flex flex-col py-10 px-4 bg-white rounded-md mt-10 mx-auto items-center">
